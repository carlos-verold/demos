...
MyApp.prototype.startup = function( ) {
  ...
  // turn off shadowmap to improve performance
  ...
  that.veroldApp.veroldEngine.Renderer.stats.domElement.hidden = false;  
    ...
    success_hierarchy: function( scene ) {
      ...
      // Load controls
      veroldApp.loadScript("javascripts/controls/FlyControls.js", function() {
        that.cameraControls = new THREE.FlyControls(that.camera, that.veroldApp.getRenderer().domElement);      
      });
